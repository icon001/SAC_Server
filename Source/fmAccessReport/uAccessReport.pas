...
type
  TfmAccessReport = class(TfmASubForm)
    ...
    ed_CardNo: TAdvEdit;
    rg_DateType: TAdvOfficeRadioGroup;
...
begin
  ...
  rg_DateType.ItemIndex := L_nDateType;
...
begin
  Try
    ...
    begin
      ...
      WriteInteger('ACCESSREPORT','DateType',rg_DateType.ItemIndex);
      L_nDateType := rg_DateType.ItemIndex;
    end;
  Finally
    ini_fun.Free;
  End;
...
begin
  ...
  Try
    ...
    begin
      ...
      L_nDateType := ReadInteger('ACCESSREPORT','DateType',0);
...
begin
  ...
  stSql :=  dmDBSelect.SelectTB_ACCESSEVENT_AccessReport(stStartDate, stStartTime,
            ...
            stCardBuildingAreaCode, ed_CardNo.Text, ed_name.Text,L_nDateType);
