...
type
  ...
  public
    ...
    Function UpdateTB_DEVICECARDNO_CardNoSendType_StringValue(aNodeSeq,aCardNo,aSendType:string):string;
...
function TdmDBUpdate.UpdateTB_DEVICECARDNO_CardNoSendType_StringValue(aNodeSeq,
  aCardNo, aSendType: string): string;
var
  stSql : string;
begin
  stSql := 'Update TB_DEVICECARDNO set CA_SEND = ''' + aSendType + ''' ';
