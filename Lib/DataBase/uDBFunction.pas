...
type
  ...
  public
    ...
    Function CheckTB_CARD_Key(aCardNo:string):integer;
    ...
    Function GetCardGubunCode(aCardGubunName:string):string;
...
function TdmDBFunction.CheckTB_CARD_Key(aCardNo: string): integer;
var
  stSql : string;
  TempAdoQuery :TADOQuery;
begin
...
function TdmDBFunction.GetCardGubunCode(aCardGubunName: string): string;
var
  stSql : string;
  TempAdoQuery :TADOQuery;
begin
  result := '';
  stSql := 'select CA_GUBUN from TB_CARDGUBUNCODE ';
  stSql := stSql + ' Where  GROUP_CODE = ''' + G_stGroupCode + ''' ';
  stSql := stSql + ' AND  CA_GUBUNNAME = ''' + aCardGubunName + ''' ';
  ...
  Try
    ...
    begin
      ...
      result := FindField('CA_GUBUN').AsString;
    end;
  Finally
    TempAdoQuery.EnableControls;
    TempAdoQuery.Free;
